...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx93f7a05d43533b5e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'de620d1f2210d2bf17bd7d364b5a40c6',
  ...
  USERS: [
    {
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'oVxZd5k6LNR2VzOc3TNq3W1RAh8Q',
      // 所在省份
      province: '江苏',
      // 所在城市
      city: '宿迁',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1997', date: '11-23',
        },
        {
          type: '节日', name: '纪念日', year: '2021', date: '09-28',
        },
